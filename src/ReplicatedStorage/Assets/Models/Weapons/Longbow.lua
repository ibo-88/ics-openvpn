-- Longbow.lua
-- Модель длинного лука
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local ModelBuilder = require(ReplicatedStorage.Assets.ModelBuilder)

local function CreateLongbow()
    ...
    bow.Name = "Bow"
    bow.Size = Vector3.new(0.1, 3.5, 0.1)
    bow.Position = Vector3.new(0, 1.75, 0)
    bow.Anchored = true
    ...
    string.Name = "String"
    string.Size = Vector3.new(0.02, 3.2, 0.02)
    string.Position = Vector3.new(0, 1.75, 0.05)
    ...
    grip.Name = "Grip"
    grip.Size = Vector3.new(0.15, 0.4, 0.15)
    grip.Position = Vector3.new(0, 1.75, 0)
    grip.Anchored = true
    ...
    -- Атрибуты
    model:SetAttribute("WeaponType", "longbow")
    ...
    model:SetAttribute("WeaponDescription", "Длинный лук с высокой точностью")
