...
local function CreateThrowingMace()
    ...
    handle.Name = "Handle"
    handle.Size = Vector3.new(0.08, 1.6, 0.08)
    handle.Position = Vector3.new(0, 0.8, 0)
    ...
    spike1.Size = Vector3.new(0.08, 0.25, 0.08)
    spike1.Position = Vector3.new(0, 2.2, 0)
    ...
    spike2.Size = Vector3.new(0.08, 0.25, 0.08)
    spike2.Position = Vector3.new(0.2, 2, 0)
    ...
    spike3.Size = Vector3.new(0.08, 0.25, 0.08)
    spike3.Position = Vector3.new(-0.2, 2, 0)
    ...
    spike4.Size = Vector3.new(0.08, 0.25, 0.08)
    spike4.Position = Vector3.new(0, 1.8, 0)
    ...
    decoration1.Position = Vector3.new(0, 1.3, 0)
    ...
    decoration2.Position = Vector3.new(0, 0.6, 0)
    ...
    model:SetAttribute("WeaponValue", 950)
    model:SetAttribute("WeaponDescription", "Метательная булава с острыми шипами")
