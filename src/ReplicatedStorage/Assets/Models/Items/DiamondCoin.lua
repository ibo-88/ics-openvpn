-- DiamondCoin.lua
-- Модель алмазной монеты

local ReplicatedStorage = game:GetService("ReplicatedStorage")
local ModelBuilder = require(ReplicatedStorage.Assets.ModelBuilder)

local function CreateDiamondCoin()
    local model = Instance.new("Model")
    model.Name = "DiamondCoin"
    ...
    coin.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
    coin.Anchored = true
    ...
    coinLight.Color = Color3.fromRGB(185, 242, 255)
    coinLight.Range = 2.0
    ...
    for i = 1, 5 do
        ...
        gemLight.Color = Color3.fromRGB(185, 242, 255)
        gemLight.Range = 0.4
    ...
    for i = 1, 6 do
        ...
        rune.Name = "DiamondRune" .. i
        rune.Size = Vector3.new(0.02, 0.02, 0.01)
        rune.Material = Enum.Material.Neon
        rune.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
        rune.Anchored = true
        ...
        runeLight.Color = Color3.fromRGB(185, 242, 255)
        runeLight.Range = 0.5
        runeLight.Brightness = 1.5
        runeLight.Parent = rune
    end
    
    -- Алмазные частицы вокруг монеты
    for i = 1, 40 do
        local particle = Instance.new("Part")
        particle.Name = "DiamondParticle" .. i
        particle.Size = Vector3.new(0.008, 0.008, 0.008)
        particle.Material = Enum.Material.Neon
        particle.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
        ...
        particleLight.Color = Color3.fromRGB(185, 242, 255)
    ...
    -- Алмазные частицы от камней
    for i = 1, 20 do
        local diamondParticle = Instance.new("Part")
        diamondParticle.Name = "DiamondGemParticle" .. i
        diamondParticle.Size = Vector3.new(0.005, 0.005, 0.005)
        diamondParticle.Material = Enum.Material.Neon
        diamondParticle.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
        diamondParticle.Anchored = true
        diamondParticle.CanCollide = false
        diamondParticle.Parent = model
        
        -- Случайное позиционирование частиц
        local xPos = math.random(-0.1, 0.1)
        local yPos = math.random(-0.1, 0.1)
        local zPos = math.random(0.01, 0.08)
        diamondParticle.Position = crown.Position + Vector3.new(xPos, yPos, zPos)
        
        -- Свечение частиц
        local diamondParticleLight = Instance.new("PointLight")
        diamondParticleLight.Color = Color3.fromRGB(185, 242, 255)
        diamondParticleLight.Range = 0.25
        diamondParticleLight.Brightness = 1.2
        diamondParticleLight.Parent = diamondParticle
    end
    
    -- Алмазные частицы от рун
    for i = 1, 15 do
        local diamondRuneParticle = Instance.new("Part")
        diamondRuneParticle.Name = "DiamondRuneParticle" .. i
        diamondRuneParticle.Size = Vector3.new(0.007, 0.007, 0.007)
        diamondRuneParticle.Material = Enum.Material.Neon
        diamondRuneParticle.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
        diamondRuneParticle.Anchored = true
        diamondRuneParticle.CanCollide = false
        diamondRuneParticle.Parent = model
        
        -- Случайное позиционирование частиц
        local xPos = math.random(-0.12, 0.12)
        local yPos = math.random(-0.12, 0.12)
        local zPos = math.random(0.015, 0.06)
        diamondRuneParticle.Position = coin.Position + Vector3.new(xPos, yPos, zPos)
        
        -- Свечение частиц
        local diamondRuneParticleLight = Instance.new("PointLight")
        diamondRuneParticleLight.Color = Color3.fromRGB(185, 242, 255)
        diamondRuneParticleLight.Range = 0.3
        diamondRuneParticleLight.Brightness = 1.0
        diamondRuneParticleLight.Parent = diamondRuneParticle
    end
    
    -- Алмазная аура вокруг монеты
    local aura = Instance.new("Part")
    aura.Name = "DiamondAura"
    aura.Size = Vector3.new(0.3, 0.3, 0.1)
    aura.Material = Enum.Material.Neon
    aura.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
    ...
    auraLight.Color = Color3.fromRGB(185, 242, 255)
    auraLight.Range = 2.5
    auraLight.Brightness = 0.5
    auraLight.Parent = aura
    
    -- Алмазные кольца вокруг монеты
    for i = 1, 5 do
        local ring = Instance.new("Part")
        ring.Name = "DiamondRing" .. i
        ring.Size = Vector3.new(0.2 + i * 0.05, 0.01, 0.2 + i * 0.05)
        ring.Material = Enum.Material.Neon
        ring.Color = Color3.fromRGB(185, 242, 255) -- Алмазный
        ...
        ringLight.Color = Color3.fromRGB(185, 242, 255)
    ...
    model:SetAttribute("ItemMaterial", "diamond")
    ...
    model:SetAttribute("ItemValue", 10000)
    ...
    model:SetAttribute("CoinType", "diamond")
    model:SetAttribute("CoinValue", 10000)
    model:SetAttribute("CoinWeight", 0.1)
    model:SetAttribute("CoinRarity", "legendary")
    model:SetAttribute("CoinLevel", 10)
    model:SetAttribute("CoinMaterial", "diamond")
